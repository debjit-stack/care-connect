...
const UserList = ({ users, loggedInUser, onEdit, onDelete, onResetPassword }) => {
    return (
                    ...
                    {users.map(user => (
                        <tr key={user._id} className="hover:bg-gray-50">
                            ...
                            <td className="py-2 px-4 border-b whitespace-nowrap">
                                <button onClick={() => onEdit(user)} className="text-blue-500 hover:text-blue-700 p-1 rounded-full inline-flex items-center">
                                ...
                                <button onClick={() => onResetPassword(user)} className="text-yellow-500 hover:text-yellow-700 p-1 rounded-full inline-flex items-center ml-2">
                                ...
                                <button 
                                    ...
                                    className={`p-1 rounded-full inline-flex items-center ml-2 ${loggedInUser._id === user._id ? 'opacity-50 cursor-not-allowed text-gray-400' : 'text-red-500 hover:text-red-700'}`}
