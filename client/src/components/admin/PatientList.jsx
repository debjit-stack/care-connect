...
const PatientList = ({ patients, onEdit, onDelete, onResetPassword }) => {
    return (
                    ...
                    {patients.map(patient => (
                        <tr key={patient._id} className="hover:bg-gray-50">
                            ...
                            <td className="py-2 px-4 border-b whitespace-nowrap">
                                ...
                                <button onClick={() => onDelete(patient._id)} className="text-red-500 hover:text-red-700 p-1 rounded-full inline-flex items-center ml-2">
