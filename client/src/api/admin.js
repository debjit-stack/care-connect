...
export const updateDoctorAvailability = (id, availabilityData) =>
  API.put(`/admin/doctors/${id}`, { availability: availabilityData });
export const deleteUser = (id) => API.delete(`/admin/users/${id}`);
export const registerPatientByAdmin = (patientData) =>
  API.post('/receptionist/register-patient', patientData);